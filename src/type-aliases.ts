...
// type aliases example : type aliases
type StringOrNumber = string | number; // union type aliases 
type Employee = {
    readonly id: number; // readonly modifier => can not change value after initialized
    name: string;
    salary: number;
    phone?: StringOrNumber; // optional parameter 
    email: string;
}
let employee: Employee = { // Employee type is object type aliases 
    id: 1,
    name: "Kasidate",
    salary: 100000,
    phone: "0999999999",
