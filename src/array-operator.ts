const corner: string[] = ['Frontend', 'Backend', 'Fullstack'];
const department: string[] = ['Finance', 'Marketing', 'HR', 'IT'];

// spread operator example : spread operator is use to copy array or object to new array or object
const allDepartment: string[] = [...corner, ...department]; // copy array to new array
...
function add(...numbers: number[]): number { // rest parameter
    let total: number = 0;
