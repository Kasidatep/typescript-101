...
const error404 = ["Not Found", 404]; // define type of value in tuple and length of tuple
...
const point = [10, 20]; // define type of value in tuple and length of tuple
console.log(point); // 10
const point2 = [10, 20]; // define type of value in tuple and length of tuple
